...
client.on('ready', async () => {
  ...
  console.log(`Made by MAX GAMING YTᵈᵉᵛ#8643`)
  console.log(`Credits |  https://dsc.gg/maxgaming.yt`)
  console.log(`Join above or you gay`)
  client.user.setActivity(config.status.name, { type: config.status.type.toUpperCase(), url: "https://www.youtube.com/c/MAXGAMINGYT7" })
});
...
> \`${prefix}setstaff\` - set staff roles`)
      .setTimestamp()
      .setColor(`#33cd15`)
      .setFooter(`All rights belong to https://dsc.gg/maxgaming.yt`)
